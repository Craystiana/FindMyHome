...
namespace FindMyHome.DataAccess.Migrations
{
    ...
    [Migration("20240817195812_AddListingPictures")]
    partial class AddListingPictures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FindMyHome.Domain.Entities.Listing", b =>
                {
                    ...
                    b.Property<int>("ListingMarketingTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ListingMarketingTypeId");
            ...
            modelBuilder.Entity("FindMyHome.Domain.Entities.ListingMarketingType", b =>
                {
                    b.Property<int>("ListingMarketingTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ListingMarketingTypeId"));

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("ListingMarketingTypeId");

                    b.ToTable("ListingMarketTypes");
                });

            modelBuilder.Entity("FindMyHome.Domain.Entities.ListingPicture", b =>
                {
                    b.Property<int>("ListingPhotoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ListingPhotoId"));
            ...
            modelBuilder.Entity("FindMyHome.Domain.Entities.Listing", b =>
                {
                    ...
                    b.HasOne("FindMyHome.Domain.Entities.ListingMarketingType", "ListingMarketingType")
                        .WithMany("Listings")
                        .HasForeignKey("ListingMarketingTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ListingMarketingType");
